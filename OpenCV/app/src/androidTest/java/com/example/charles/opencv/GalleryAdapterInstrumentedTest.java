...
/**
 * Unit tests for the Gallery Adapter, requires the physical or emulated machine to run.
 */
@RunWith(AndroidJUnit4.class)
@FixMethodOrder(MethodSorters.NAME_ASCENDING)
public class GalleryAdapterInstrumentedTest extends ActivityTestCase {
